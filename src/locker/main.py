...
class MainArgs(ArgumentParser):
    ...
    def __init__(self, description=_desc):
        ...
        self.add_argument("--key", dest="key", type=str)
...
def do_action(decrypt: bool, key: str, source: str, dest: str) -> str | None:
...
if __name__ == "__main__":
    ...
    do_action(args.decrypt, args.key, args.source, args.dest)
